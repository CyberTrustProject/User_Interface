...
window.onload = function () {
    ...
    var init = function (json_data) {
        ...
        var pieChart01 = aframedc.pieChart();
        pieChart01.dimension(dimByOrg).group(groupByOrg).color().radius(2.5).setTitle("LOL");
        //var coordPieChart = new THREE.Vector3(-3.46, 3.7, -16.8);
        ////myDashboard.addChart(mypiechart, coordPieChart);

        var pieChart02 = aframedc.pieChart();
        var pieChart03 = aframedc.pieChart();
...
"#9ACD32"]
        ...
        mypiechart.dimension(dimByOrg).group(groupByOrg).color(orgsColors).radius(2.5).setTitle("ziocane");
        mystackchartOrgs.dimension(dimbyYandQ)
            ...
            .width(15).height(15).setTitle("aaaa");

        var coordPieChart = new THREE.Vector3(-3.46, 3.7, -16.8);
        var coordorgweekchart = new THREE.Vector3(40, 20, -18);
        ...
        var coordautchart = new THREE.Vector3(-40, 20, -18);
        //myDashboard.addChart(mybarchartaut, coordautchart);
        mybarchartaut.setAttribute("rotation", { x: 0, y: 0, z: 0 });
        ...
        //myDashboard.addChart(mybarchart, { x: 5, y: 20, z: -18 });
