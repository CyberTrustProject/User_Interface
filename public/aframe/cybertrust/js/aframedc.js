...
initChart: function () {
        ...
        for (var j = 0; j < dataValues.length; j++) {
            ...
            el.setAttribute("position", { x: relativeX-15, y: relativeY, z: 20 });
    ...
    addTitle: function () {
		...
		titleEntity.setAttribute("position", { x: this.data.radius-15, y: (this.data.radius * 2) + 1, z: this.data.depth / 2 +20 });
		titleEntity.setAttribute("rotation", {  x: 0, y: 90, z: 0 });
        this.el.appendChild(titleEntity);
    },
    addEvents: utils.addEvents,
  /**
