...
"#9ACD32"]
        ...
        mybarchartTzs.dimension(dimbytz).group(groupbytz).color("#ffc107").width(10).setTitle("Users registrated");


        //front

        mypiechart.dimension(dimByOrg).group(groupByOrg).color(orgsColors).radius(2.5).setTitle("Sensors in error");
        ...
        mystackchartOrgs.dimension(dimbyYandQ)
            ...
            .width(15).height(15).setTitle("most active events");
        ...
        mybarchartaut.dimension(dimbyYandQ).group(groupAuthors)
            .valueAccessor(function (data) { return data.value.counting; }).color("#f86c6b")
            .keyAccessor(keyaccessor).width(20).height(12).setTitle("Resolved cases");
        ...
        angle = Math.PI;
        mybarchart.dimension(dimbyYandQ).group(groupbyYandQ).keyAccessor(keyaccessor).width(15).setTitle("Malwares by zone");
        ...
        backgrounds = [{ imgprefix: "img/skycubemap-"  , extension:"jpg"},{ imgprefix: "img/signoria-", extension: "png" }];
        function counter()
        {
            var i = 0;
            return function() 
